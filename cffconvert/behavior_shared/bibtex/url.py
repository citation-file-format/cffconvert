...
class BibtexUrlShared:
    ...
    def __init__(self, cffobj):
        self._cffobj = cffobj
        self._behaviors = {
            'IRACU': self._from_url,
            'IRAC_': self._from_repository_code,
            'IRA_U': self._from_url,
            'IRA__': self._from_repository,
            'IR_CU': self._from_url,
            'IR_C_': self._from_repository_code,
            'IR__U': self._from_url,
            'IR___': self._from_repository,
            'I_ACU': self._from_url,
            'I_AC_': self._from_repository_code,
            'I_A_U': self._from_url,
            'I_A__': self._from_repository_artifact,
            'I__CU': self._from_url,
            'I__C_': self._from_repository_code,
            'I___U': self._from_url,
