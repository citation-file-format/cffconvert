...
class BibtexAuthor(AbstractAuthor):
    ...
    def __init__(self, author):
        ...
        self._behaviors = {
            ...
            '__ANAOE': self._from_alias,
            '__ANAO_': self._from_alias,
            '__ANA_E': self._from_alias,
            '__ANA__': self._from_alias,
            '__AN_OE': self._from_alias,
            '__AN_O_': self._from_alias,
