...
class ZenodoAuthor(AbstractAuthor):
    ...
    def __init__(self, author):
        ...
        self._behaviors = {
            ...
            '__ANAOE': self._from_alias_and_affiliation_and_orcid,
            '__ANAO_': self._from_alias_and_affiliation_and_orcid,
            '__ANA_E': self._from_alias_and_affiliation,
            '__ANA__': self._from_alias_and_affiliation,
            '__AN_OE': self._from_alias_and_orcid,
            '__AN_O_': self._from_alias_and_orcid,
            '__AN__E': self._from_alias,
            '__AN___': self._from_alias,
