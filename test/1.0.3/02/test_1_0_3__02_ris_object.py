...
class TestRisObject(Contract):
    ...
    def test_author(self, ris_object):
        ...
        assert ris_object.author == 'AU  - Fernández de Córdoba Jr., Gonzalo\n'
    ...
    def test_date(self, ris_object):
        ris_object.add_date()
        assert ris_object.date == 'DA  - 1999-12-31\n'
    ...
    def test_title(self, ris_object):
        ...
        assert ris_object.title == 'TI  - example title\n'
    ...
    def test_year(self, ris_object):
        ris_object.add_year()
        assert ris_object.year == 'PY  - 1999\n'
