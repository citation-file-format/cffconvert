...
class ApalikeObjectTest(Contract, unittest.TestCase):
    ...
    def test_author(self):
        self.ao.add_author()
        self.assertEqual(self.ao.author, 'Spaaks J.H., Klaver T., Verhoeven S., Druskat S.')
    ...
    def test_title(self):
        self.ao.add_title()
        self.assertEqual(self.ao.title, 'cffconvert')

    def test_version(self):
        self.ao.add_version()
        self.assertEqual(self.ao.version, ' (version 1.0.1). ')
