...
class BibtexObjectTest8(unittest.TestCase):
    ...
    def test_author(self):
        ...
        bo.add_author()
        self.assertTrue(bo.author == 'author = {Jurriaan H. Spaaks and Tom Klaver and Stefan Verhoeven}')
    ...
    def test_month(self):
        bo = BibtexObject(self.cff_object, initialize_empty=True)
        bo.add_month()
        self.assertTrue(bo.month == 'month = {5}')
    ...
    def test_title(self):
        bo = BibtexObject(self.cff_object, initialize_empty=True)
        bo.add_title()
        self.assertTrue(bo.title == 'title = {cffconvert}')
