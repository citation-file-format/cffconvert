...
class ZenodoObjectTest8(unittest.TestCase):
    ...
    def test_publication_date(self):
        ...
        self.assertEqual(zo.publication_date, '2018-05-09')

    def test_title(self):
        zo = ZenodoObject(self.cff_object, initialize_empty=True)
        zo.add_title()
        self.assertEqual(zo.title, 'cffconvert')

    def test_version(self):
        zo = ZenodoObject(self.cff_object, initialize_empty=True)
        zo.add_version()
        self.assertEqual(zo.version, '0.0.4')
